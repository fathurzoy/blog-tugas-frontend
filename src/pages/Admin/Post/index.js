...
class Post extends Component {
  ...
  deletePost(id) {
    ...
    window.location = "/fathurzoy/posts";
  }
        ...
        <>
          ...
          <div className="card">
            <div className="card-body">
              <Link to={"/fathurzoy/posts/" + this.props.post._id}>
              ...
              ></div> */}
                <MDEditor.Markdown
                  source={this.props.post.body.substring(0, 400).trim() + "..."}
                  linkTarget="_blank"
                  // previewOptions={{
                  //   linkTarget: "_blank"
                  // }}
              ...
              <div className="card">
                ...
                ></div> */}
                  ...
                  {this.state.isLoggedIn ? (
                    <span>
                      <Link
                        to={`/fathurzoy/posts/${this.state.post._id}/edit`}
